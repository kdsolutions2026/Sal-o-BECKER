const products = [
  {
    id: "pagamento-teste-1-real",
    name: "Teste de pagamento - R$ 1,00",
    category: "Teste de checkout",
    price: 1,
    rating: 5,
    reviews: 1,
    image: "assets/img/brand/becker-wordmark-oficial.png",
    description: "Produto temporario criado exclusivamente para validar o fluxo de pagamento da Loja Becker.",
    benefits: ["Pagamento real", "Valor controlado", "Uso temporario"],
    idealFor: "Teste controlado do Pix, cartao, banco de pedidos e webhook do Mercado Pago.",
    usage: "Adicione uma unidade, escolha retirada no salao e conclua somente durante o teste acompanhado.",
    tip: "Este item nao representa um produto fisico e sera removido depois da validacao do checkout.",
    ingredients: "Nao se aplica. Este e um item virtual e temporario para teste tecnico do checkout.",
    ingredientsNote: "Nao enviar, separar ou despachar este item. Remover da loja apos a homologacao.",
    seoDescription: "Item temporario de R$ 1,00 para teste tecnico do checkout da Loja Becker.",
    isTestProduct: true
  },
  {
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 37,
    image: "assets/products/catalog/sh-rd-protein-cream.png",
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 14,
    image: "assets/products/catalog/wella-ultimate-luxe-oil-conditioner.png",
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 12,
    image: "assets/products/catalog/wella-ultimate-luxe-shampoo.png",
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 11,
    image: "assets/products/catalog/lanza-detangling-primer.jpg",
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 18,
    image: "assets/products/catalog/kerastase-nutritive-lait-vital.jpg?v=20260703a",
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 9,
    image: "assets/products/catalog/paul-mitchell-clarify-shampoo-two.jpg",
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 13,
    image: "assets/products/catalog/paul-mitchell-tea-tree-special-shampoo.jpg",
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 7,
    image: "assets/products/catalog/paul-mitchell-tea-tree-body-bar.jpg",
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 10,
    image: "assets/products/catalog/tangle-teezer-detangling-hairbrush.jpg",
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 9,
    image: "assets/products/catalog/bounce-curl-brush.png",
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 6,
    image: "assets/products/catalog/miracle-luminous-elixir.png",
