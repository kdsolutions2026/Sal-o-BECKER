const productsRaw = [
  {
    ...
    benefits: ["ReparaÃ§Ã£o", "Maciez", "Elasticidade", "ProteÃ§Ã£o UV"],
  ...
  },
  {
    ...
    benefits: ["DefiniÃ§Ã£o", "EmoliÃªncia", "Maciez", "Cachos"],
  ...
  },
  {
    ...
    benefits: ["ReparaÃ§Ã£o", "NutriÃ§Ã£o", "Controle de frizz", "Brilho"],
  ...
  },
  {
    ...
    benefits: ["HidrataÃ§Ã£o", "Maciez", "Toque sedoso", "Cabelo seco"],
  ...
  },
  {
    ...
    benefits: ["NutriÃ§Ã£o", "HidrataÃ§Ã£o", "Cabelo seco", "Brilho"],
  ...
  },
  {
    ...
    benefits: ["ProteÃ§Ã£o da cor", "HidrataÃ§Ã£o", "Cabelos coloridos", "Sensibilidade"],
  ...
  },
  {
    ...
    benefits: ["MÃ¡scara", "Cor", "Porosidade", "Cabelo sensibilizado"],
  ...
  },
  {
    ...
    benefits: ["Brilho", "FinalizaÃ§Ã£o", "Ã”mega-9", "Todos os fios"],
  ...
  },
  {
    ...
    benefits: ["Brilho", "Maciez", "Pontas", "UmectaÃ§Ã£o"],
  ...
  },
  {
    ...
    benefits: ["NutriÃ§Ã£o", "CÃ­lios", "Sobrancelhas", "UmectaÃ§Ã£o"],
  ...
  },
  {
    ...
    benefits: ["HidrataÃ§Ã£o", "Pele", "Cabelo", "Antioxidante"],
...
const repairText = (value) => {
  ...
  try {
    return /[Ãâ]/.test(value) ? decodeURIComponent(escape(value)) : value;
  } catch {
    return value;
  }
};
...
const normalizeText = (value = "") =>
  repairText(String(value)).normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase();

const products = productsRaw.map((product) => ({
  ...product,
  name: repairText(product.name),
  category: repairText(product.category),
  priceLabel: repairText(product.priceLabel || ""),
  description: repairText(product.description),
  benefits: (product.benefits || []).map(repairText),
  tip: repairText(product.tip || "")
}));
...
const productFulfillment = (product) =>
  hasPrice(product) ? "Retirada no salão ou envio local combinado" : "Atendimento e reserva pelo WhatsApp";
...
const anaileTip = (product) => `
  <aside class="anaile-tip">
    <div class="anaile-head">
      <img src="${assetUrl("assets/img/anaile-avatar.webp")}" alt="Anaile, fundadora do Salão Becker">
      <div>
...
function renderShop() {
  ...
  if (summary) {
    ...
    else if (state.filter !== "Todos") summary.textContent = `${list.length} ${list.length === 1 ? "produto disponível" : "produtos disponíveis"} em ${state.filter}.`;
    else summary.textContent = `${list.length} produtos na curadoria profissional do salão.`;
  }
