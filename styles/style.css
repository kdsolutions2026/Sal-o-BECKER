...
.nav-action{display:inline-flex;align-items:center;justify-content:center;min-height:38px;padding:10px 16px;border:1px solid rgba(251,250,247,.52);border-radius:999px;color:var(--ivory);font-size:.68rem;font-weight:800;letter-spacing:.12em;text-transform:uppercase;transition:.22s ease}
.nav-action:hover,.nav-action.active{background:var(--champagne);border-color:var(--champagne);color:var(--ink)}
.nav-social{display:inline-flex;align-items:center;justify-content:center;min-height:38px;padding:10px 15px;border:1px solid rgba(251,250,247,.34);border-radius:999px;color:var(--ivory);font-size:.68rem;font-weight:900;letter-spacing:.1em;text-transform:uppercase}
.nav-social:hover{background:var(--ivory);color:var(--ink)}
.cart-button{min-width:42px;width:42px;height:42px;padding:0;justify-content:center;border-radius:50%;position:relative}
...
.home-slide img{width:100%;height:100%;object-fit:cover;filter:saturate(1.02) contrast(1.02)}
...
.location-videos .video-feature{align-items:center}
.location-videos .video-feature video{aspect-ratio:9/16;max-height:720px;width:min(440px,100%);justify-self:center;object-fit:contain;background:#050505}
.location-videos .video-grid{align-items:start}
.location-videos .video-grid article{display:grid;gap:14px;align-content:start}
.location-videos .video-grid video{display:block;width:100%;max-width:360px;aspect-ratio:9/16;height:auto;object-fit:contain;background:#050505;margin:0 auto;box-shadow:0 24px 56px rgba(0,0,0,.3)}
.location-videos .section-title{font-size:clamp(1.95rem,3.5vw,3.8rem);white-space:nowrap}
.location-video-text{display:grid;gap:16px;max-width:560px}
.location-video-text h3{font-family:"Playfair Display",Georgia,serif;font-size:clamp(2rem,4vw,3.6rem);line-height:1.02}
...
@media (max-width:1120px){.location-detail-list{grid-template-columns:repeat(3,1fr)}.location-videos .video-feature video{width:min(420px,100%)}.location-videos .video-grid video{max-width:340px}}
@media (max-width:720px){body[data-page="localizacao"] .page-hero{min-height:72svh}.location-address-card{padding:20px}.location-detail-list{grid-template-columns:1fr}.location-gallery{grid-auto-rows:230px}.location-videos .video-feature video,.location-videos .video-grid video{width:100%;max-width:none;max-height:78svh}.location-videos .section-title{white-space:normal}.location-video-text .btn{width:100%}}
...
@media (max-width:720px){
  ...
  body[data-page="home"] .home-slide:nth-child(1) img{object-position:48% center!important;}
  body[data-page="home"] .home-slide:nth-child(2) img{object-position:70% center!important;}
  body[data-page="home"] .home-slide:nth-child(3) img{object-position:72% center!important;}
...
body[data-page="loja"] .shop-filter-row{overflow:hidden}
body[data-page="loja"] .shop-filter-list{display:flex;gap:10px;overflow:auto;padding-bottom:2px;scrollbar-width:none}
body[data-page="loja"] .shop-filter-list::-webkit-scrollbar{display:none}
body[data-page="loja"] .shop-filter-option{display:inline-flex;align-items:center;gap:8px;flex:0 0 auto;padding:10px 14px;border:1px solid rgba(21,19,17,.1);border-radius:999px;background:#fff;color:var(--ink);font-size:.92rem;font-weight:700}
body[data-page="loja"] .shop-filter-option span{letter-spacing:0;text-transform:none}
body[data-page="loja"] .shop-filter-option small{display:grid;place-items:center;min-width:24px;height:24px;padding:0 6px;border-radius:999px;background:#f1ece4;color:var(--muted);font-size:.76rem;font-weight:800}
body[data-page="loja"] .shop-filter-option:hover,
body[data-page="loja"] .shop-filter-option.active{border-color:rgba(152,116,59,.44);background:#fcf8f1}
body[data-page="loja"] .shop-filter-option.active small{background:rgba(152,116,59,.14);color:var(--oldgold)}
...
body[data-page="loja"] .shop-product-card .benefit-list{display:flex;flex-wrap:wrap;gap:8px}
...
.location-videos .video-feature video,
.location-videos .video-grid video{
  pointer-events:auto;
}
@media (max-width:1120px){
  .location-gallery{
